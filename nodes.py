...
from .nodes_wanvideo_adapter import (  # noqa: E402
    NODE_CLASS_MAPPINGS as WANVIDEO_ADAPTER_NODE_CLASS_MAPPINGS,
    NODE_DISPLAY_NAME_MAPPINGS as WANVIDEO_ADAPTER_NODE_DISPLAY_NAME_MAPPINGS,
)
...
NODE_CLASS_MAPPINGS.update(WANVIDEO_ADAPTER_NODE_CLASS_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(WANVIDEO_ADAPTER_NODE_DISPLAY_NAME_MAPPINGS)
