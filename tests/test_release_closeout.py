...
class ReleaseCloseoutTests(unittest.TestCase):
    ...
    def test_readme_lists_final_scail2_nodes_and_boundaries(self) -> None:
        ...
        self.assertIn("valid mask alignment remains preferred", readme)
        self.assertIn("can fall back to safe bbox repair", readme)
        self.assertIn("module_file=nodes.py", readme)
        self.assertIn("nodes_sha256", readme)
        ...
        self.assertIn("samples_initialization_contract", readme)
