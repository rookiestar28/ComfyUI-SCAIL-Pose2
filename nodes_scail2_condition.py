...
class SCAILPose2SCAIL2Condition:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "reference_fit_mode": (
                    ["auto", "contain", "cover", "fit_height", "fit_width"],
                    {"default": "auto"},
                ),
                "reference_anchor": (
                    ["auto", "bottom_center", "center"],
                    {"default": "auto"},
                ),
    ...
    def build(
        ...
        height,
        num_frames,
        reference_fit_mode="auto",
        reference_anchor="auto",
        reference_target_frame_policy="median_bbox",
        reference_control_region="auto",
        ...
        if mode == "replacement":
            ...
            ref_image, ref_mask = _align_replacement_reference_geometry(
                ...
                control_region=reference_control_region,
